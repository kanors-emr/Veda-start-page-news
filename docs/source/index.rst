...
`Version 2.011.1.1 <https://github.com/kanors-emr/Veda2.0-Installation>`_ has been released.
   ...
   * **We have started developing "Veda Assistant" functionality that would prove useful for new users as well power users. See "Create Tag" button on Information - Veda and TIMES Parameters.**
